...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        ...
        var requestOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: __WEBPACK_IMPORTED_MODULE_2__headers__["a" /* contentHeaders */], params: params });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__register_index__ = __webpack_require__("./src/app/register/index.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__navi_index__ = __webpack_require__("./src/app/navi/index.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__register_index__["a" /* RegisterComponent */],
            __WEBPACK_IMPORTED_MODULE_12__navi_index__["a" /* NaviComponent */]
        ],
        imports: [
...
/***/ "./src/app/navi/index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__navi_component__ = __webpack_require__("./src/app/navi/navi.component.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__navi_component__["a"]; });
...
module.exports = "<nav class=\" navbar-default navbar-small\" role=\"navigation\">\n    <div class=\"container-fluid \">\n        <!-- Brand and toggle get grouped for better mobile display -->\n        <div class=\"navbar-header\">\n            <a class=\"navbar-brand\" routerLink=\"/\">Loklak publisher</a>\n        </div>\n\n        <!-- login navi -->\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\" *ngIf=\"showLoginNav\">\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"active\"><a routerLink='/login' (click)=\"logout()\">Log out</a></li>\n            </ul>\n        </div>\n        <!--login navi -->\n\n        <!-- normal navi -->\n        <!-- Collect the nav links, forms, and other content for toggling -->\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\" *ngIf=\"showNormalNav\">\n\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li><a routerLink='/register'>Register</a></li>\n                <!-- login dropdown -->\n                <li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><b>Login</b> <span class=\"caret\"></span></a>\n                    <ul id=\"login-dp\" class=\"dropdown-menu\">\n                        <li>\n                            <div class=\"row\">\n                                <div class=\"col-md-12\">\n                                    <form name=\"form\" (ngSubmit)=\"f.form.valid && login()\" #f=\"ngForm\" novalidate>\n                                        <div class=\"form-group col-xs-12\" [ngClass]=\"{ 'has-error': f.submitted && !username.valid }\">\n                                            <br>\n                                            <label class=\"sr-only\" for=\"exampleInputEmail2\">Email address</label>\n                                            <input type=\"text\" class=\"form-control\" name=\"username\" placeholder=\"Email address\" [(ngModel)]=\"model.username\" #username=\"ngModel\" required />\n                                            <div *ngIf=\"f.submitted && !username.valid\" class=\"help-block\">Username is required</div>\n                                        </div>\n                                        <div class=\"form-group col-xs-12\" [ngClass]=\"{ 'has-error': f.submitted && !password.valid }\">\n                                            <label class=\"sr-only\" for=\"exampleInputPassword2\">Password</label>\n                                            <input type=\"password\" class=\"form-control\" name=\"password\" [(ngModel)]=\"model.password\" #password=\"ngModel\" placeholder=\"Password\" required />\n                                            <div *ngIf=\"f.submitted && !password.valid\" class=\"help-block\">Password is required</div>\n                                            <div class=\"help-block text-right\"><a href=\"\">Forget the password ?</a></div>\n                                        </div>\n\n                                        <div class=\"form-group col-md-9\">\n                                            <label class=\"checkbox checkbox-red\" for=\"checkbox2\">\n                                                <input type=\"checkbox\" value=\"\" id=\"checkbox2\" data-toggle=\"checkbox\" unchecked> Remember me\n                                                </label>\n                                        </div>\n                                        <div class=\"row col-md-10\">\n                                            <div class=\"form-group col-md-8\">\n                                                <button type=\"submit\" class=\"btn btn-danger btn-fill btn-block\">Sign In</button>\n                                            </div>\n\n                                            <div class=\"social-buttons col-md-3\">\n                                                <a href=\"#\" class=\"btn btn-info btn-fill\"><i class=\"fa fa-twitter\"></i>Twitter</a>\n                                            </div>\n                                        </div>\n                                    </form>\n                                </div>\n                                <div class=\"bottom text-center\">\n                                    New here ? <a routerLink='/register'><b>Join Us</b></a>\n                                </div>\n                            </div>\n                        </li>\n                    </ul>\n                </li>\n                <!-- login dropdown -->\n                <!--<li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">More<b class=\"caret\"></b></a>\n                    <ul class=\"dropdown-menu\">\n                        <li><a href=\"#\">Action</a></li>\n                        <li><a href=\"#\">Another action</a></li>\n                        <li><a href=\"#\">Something else here</a></li>\n                        <li class=\"divider\"></li>\n                        <li><a href=\"#\">Separated link</a></li>\n                        <li class=\"divider\"></li>\n                        <li><a href=\"#\">One more separated link</a></li>\n                    </ul>\n                </li>-->\n            </ul>\n\n        </div>\n        <!-- /.navbar-collapse -->\n    </div>\n    <!-- /.container-fluid -->\n</nav>"

/***/ }),

/***/ "./src/app/navi/navi.component.sass":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_index__ = __webpack_require__("./src/app/_services/index.ts");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NaviComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NaviComponent = (function () {
    function NaviComponent(route, router, authenticationService, alertService) {
        this.route = route;
        this.router = router;
        this.authenticationService = authenticationService;
        this.alertService = alertService;
    ...
    NaviComponent.prototype.login = function () {
        var _this = this;
        this.loading = true;
        this.authenticationService.login(this.model.username, this.model.password)
            .subscribe(function (data) {
            _this.router.navigate([_this.returnUrl]);
            _this.showNormalNav = false;
            _this.showLoginNav = true;
    ...
    NaviComponent.prototype.logout = function () {
        localStorage.removeItem('currentUser');
        this.showNormalNav = true;
        this.showLoginNav = false;
    };
...
NaviComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
        selector: 'app-navi',
        template: __webpack_require__("./src/app/navi/navi.component.html"),
        styles: [__webpack_require__("./src/app/navi/navi.component.sass")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_index__["b" /* AuthenticationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_index__["b" /* AuthenticationService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services_index__["a" /* AlertService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_index__["a" /* AlertService */]) === "function" && _d || Object])
], NaviComponent);
...
module.exports = "<div class=\"col-md-12 fs\">\n    <div class=\"col-md-6\">\n        <h2>Register</h2>\n        <form name=\"form\" (ngSubmit)=\"f.form.valid && register()\" #f=\"ngForm\" novalidate>\n            <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !username.valid }\">\n                <label for=\"username\">Username</label>\n                <input type=\"text\" class=\"form-control\" name=\"username\" [(ngModel)]=\"model.username\" #username=\"ngModel\" required />\n                <div *ngIf=\"f.submitted && !username.valid\" class=\"help-block\">Username is required</div>\n            </div>\n            <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !password.valid }\">\n                <label for=\"password\">Password</label>\n                <input type=\"password\" class=\"form-control\" name=\"password\" [(ngModel)]=\"model.password\" #password=\"ngModel\" required />\n                <div *ngIf=\"f.submitted && !password.valid\" class=\"help-block\">Password is required</div>\n            </div>\n            <div class=\"form-group\">\n                <button [disabled]=\"loading\" class=\"btn btn-danger\">Register</button>\n                <img *ngIf=\"loading\" src=\"data:image/gif;base64,\"\n                />\n                <a [routerLink]=\"['/login']\" class=\"btn btn-link\">Cancel</a>\n            </div>\n        </form>\n    </div>\n</div>"
